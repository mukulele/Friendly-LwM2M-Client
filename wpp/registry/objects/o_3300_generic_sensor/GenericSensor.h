/*
 * GenericSensor
 * Generated on: 2025-11-12 12:46:11
 * Created by: Sinai RnD
 */

#ifndef WPP_O_3300_GENERIC_SENSOR_H
#define WPP_O_3300_GENERIC_SENSOR_H

#include "GenericSensorConfig.h"
#include "GenericSensorInfo.h"
#include "Instance.h"
...
class GenericSensor : public Instance {
public:
	enum ID: ID_T {
...
public:
	GenericSensor(lwm2m_context_t &context, const OBJ_LINK_T &id);
	~GenericSensor();
	 ...
	 */
	static GenericSensor * instance(WppClient &ctx, ID_T instId = ID_T_MAX_VAL);
	 ...
	 */
	static GenericSensor * createInst(WppClient &ctx, ID_T instId = ID_T_MAX_VAL);
...
#endif /* WPP_O_3300_GENERIC_SENSOR_H */
