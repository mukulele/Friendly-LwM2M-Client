...
#ifndef WPP_O_3336_LOCATIONIPSO_H
#define WPP_O_3336_LOCATIONIPSO_H

#include "LocationipsoConfig.h"
#include "LocationipsoInfo.h"
#include "Instance.h"
...
class Locationipso : public Instance {
public:
	enum ID: ID_T {
...
public:
	Locationipso(lwm2m_context_t &context, const OBJ_LINK_T &id);
	~Locationipso();
	 ...
	 */
	static Locationipso * instance(WppClient &ctx, ID_T instId = ID_T_MAX_VAL);
	 ...
	 */
	static Locationipso * createInst(WppClient &ctx, ID_T instId = ID_T_MAX_VAL);
...
#endif /* WPP_O_3336_LOCATIONIPSO_H */
