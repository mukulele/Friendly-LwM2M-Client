...
void AnalogOutput::resourcesInit() {
	...
	resource(ANALOG_OUTPUT_CURRENT_VALUE_5650)->set<FLOAT_T>(0.0f); // TODO: Set appropriate value
	// resource(ANALOG_OUTPUT_CURRENT_VALUE_5650)->setDataVerifier( /* TODO: Add data verifier if needed */ );
	#if RES_3203_5750
