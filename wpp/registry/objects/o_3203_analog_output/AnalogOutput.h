/*
 * AnalogOutput
 * Generated on: 2025-11-12 12:46:10
 * Created by: Sinai RnD
 */

#ifndef WPP_O_3203_ANALOG_OUTPUT_H
#define WPP_O_3203_ANALOG_OUTPUT_H

#include "AnalogOutputConfig.h"
#include "AnalogOutputInfo.h"
#include "Instance.h"
...
class AnalogOutput : public Instance {
public:
	enum ID: ID_T {
		ANALOG_OUTPUT_CURRENT_VALUE_5650 = 5650,
		#if RES_3203_5750
...
public:
	AnalogOutput(lwm2m_context_t &context, const OBJ_LINK_T &id);
	~AnalogOutput();
	 ...
	 */
	static AnalogOutput * instance(WppClient &ctx, ID_T instId = ID_T_MAX_VAL);
	 ...
	 */
	static AnalogOutput * createInst(WppClient &ctx, ID_T instId = ID_T_MAX_VAL);
...
#endif /* WPP_O_3203_ANALOG_OUTPUT_H */
