/*
 * Voltage
 * Generated on: 2025-11-12 12:46:14
 * Created by: Sinai RnD
 */

#ifndef WPP_O_3316_VOLTAGE_H
#define WPP_O_3316_VOLTAGE_H

#include "VoltageConfig.h"
...
public:
	Voltage(lwm2m_context_t &context, const OBJ_LINK_T &id);
	~Voltage();
	 ...
	 */
	static Voltage * instance(WppClient &ctx, ID_T instId = ID_T_MAX_VAL);
	 ...
	 */
	static Voltage * createInst(WppClient &ctx, ID_T instId = ID_T_MAX_VAL);
