...
#ifndef WPP_O_3342_ONOFF_SWITCH_H
#define WPP_O_3342_ONOFF_SWITCH_H

#include "OnoffSwitchConfig.h"
#include "OnoffSwitchInfo.h"
#include "Instance.h"
...
class OnoffSwitch : public Instance {
public:
	enum ID: ID_T {
...
public:
	OnoffSwitch(lwm2m_context_t &context, const OBJ_LINK_T &id);
	~OnoffSwitch();
	 ...
	 */
	static OnoffSwitch * instance(WppClient &ctx, ID_T instId = ID_T_MAX_VAL);
	 ...
	 */
	static OnoffSwitch * createInst(WppClient &ctx, ID_T instId = ID_T_MAX_VAL);
...
#endif /* WPP_O_3342_ONOFF_SWITCH_H */
