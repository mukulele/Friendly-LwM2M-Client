/*
 * AnalogInput
 * Generated on: 2025-11-12 12:56:11
 * Created by: Sinai RnD
 */

#ifndef WPP_O_3202_ANALOG_INPUT_H
#define WPP_O_3202_ANALOG_INPUT_H

#include "AnalogInputConfig.h"
#include "AnalogInputInfo.h"
#include "Instance.h"
...
class AnalogInput : public Instance {
public:
	enum ID: ID_T {
		ANALOG_INPUT_CURRENT_VALUE_5600 = 5600,
		#if RES_3202_5601
...
public:
	AnalogInput(lwm2m_context_t &context, const OBJ_LINK_T &id);
	~AnalogInput();
	 ...
	 */
	static AnalogInput * instance(WppClient &ctx, ID_T instId = ID_T_MAX_VAL);
	 ...
	 */
	static AnalogInput * createInst(WppClient &ctx, ID_T instId = ID_T_MAX_VAL);
...
#endif /* WPP_O_3202_ANALOG_INPUT_H */
