...
void AnalogInput::resourcesInit() {
	...
	resource(ANALOG_INPUT_CURRENT_VALUE_5600)->set<FLOAT_T>(0.0f); // TODO: Set appropriate value
	// resource(ANALOG_INPUT_CURRENT_VALUE_5600)->setDataVerifier( /* TODO: Add data verifier if needed */ );
	#if RES_3202_5601
