/*
 * PushButton
 * Generated on: 2025-11-12 12:56:24
...
void PushButton::resourcesInit() {
	...
	resource(DIGITAL_INPUT_STATE_5500)->set<BOOL_T>(false); // TODO: Set appropriate value
	// resource(DIGITAL_INPUT_STATE_5500)->setDataVerifier( /* TODO: Add data verifier if needed */ );
	#if RES_3347_5501
	resource(DIGITAL_INPUT_COUNTER_5501)->set<INT_T>(0); // TODO: Set appropriate value
	// resource(DIGITAL_INPUT_COUNTER_5501)->setDataVerifier( /* TODO: Add data verifier if needed */ );
	#endif
	#if RES_3347_5750
