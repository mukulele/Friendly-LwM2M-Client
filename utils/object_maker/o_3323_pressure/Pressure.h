/*
 * Pressure
 * Generated on: 2025-11-12 12:56:19
 * Created by: Sinai RnD
 */

#ifndef WPP_O_3323_PRESSURE_H
#define WPP_O_3323_PRESSURE_H

#include "PressureConfig.h"
...
class Pressure : public Instance {
public:
	enum ID: ID_T {
...
public:
	Pressure(lwm2m_context_t &context, const OBJ_LINK_T &id);
	~Pressure();
	 ...
	 */
	static Pressure * instance(WppClient &ctx, ID_T instId = ID_T_MAX_VAL);
	 ...
	 */
	static Pressure * createInst(WppClient &ctx, ID_T instId = ID_T_MAX_VAL);
