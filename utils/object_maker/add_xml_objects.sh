...
# Automated LwM2M Object Integration Script
# This script processes all XML files in /config and integrates them into the LwM2M client
...
XML_FILES=(./lwm2m-object-*.xml)cd "$(dirname "$0")/utils/object_maker"
