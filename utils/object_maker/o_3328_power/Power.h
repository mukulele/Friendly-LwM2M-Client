...
#ifndef WPP_O_3328_POWER_H
#define WPP_O_3328_POWER_H
...
public:
	Power(lwm2m_context_t &context, const OBJ_LINK_T &id);
	~Power();
	 ...
	 */
	static Power * instance(WppClient &ctx, ID_T instId = ID_T_MAX_VAL);
	 ...
	 */
	static Power * createInst(WppClient &ctx, ID_T instId = ID_T_MAX_VAL);
